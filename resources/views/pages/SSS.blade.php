@extends('layouts.app', ['activePage' => 'SSS', 'titlePage' => __('SSS')])
  ...
  <div class="container-fluid">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple" class="TableData">
                                    ...
                                    <tbody>
                                    @foreach($data_sss as $data_sss) 
                                        <tr>
                                  <td>{{$data_sss->id}}</td>
                                  <td>{{$data_sss->sss_name}}</td>
                                  <td>{{$data_sss->number}}</td>
                                        <td>
	...
	<div id="addEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			...
			<form action="add_sss" method="post" enctype="multipart/form-data">
                      {{ csrf_field() }}
			...
			<div class="modal-body">					
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            <label>SSS</label>
                            <input name="sss_name" type="text" class="form-control" required>
                        </div>	
                    </div>		
                    <div class="form-group">
                        <div class="col-12">
	...
	<div id="editEmployeeModal" class="modal fade">
		<div class="modal-dialog">
            ...
            <form action="editsss" method="post" enctype="multipart/form-data" id="editForm">
                      {{ csrf_field() }}
					<div class="modal-header">						
          ...
          <div class="modal-body">
                    <div class="form-group">
                        <div class="col-12">
                            <label>SSS</label>
                            <input id="EditSss" name="EditSss" type="text" class="form-control" required>
                        </div>	
                    </div>		
                    <div class="form-group">
                        <div class="col-12">
              ...
              $(document).ready(function(){
                  ...
                  $('.TableData').on('click', '#deletebtn', function(){
                    ...
                    //   $('#youth_name').val(data[1]);
                      $('#delete_modal_Form').attr('action', 'sss-delete/'+data[0]);
                  ...
                  $('.TableData').on('click', '#editbtn', function(){
                    $tr = $(this).closest('tr');
                      ...
                      $('#editForm').attr('action', 'editsss/'+data[0]);
