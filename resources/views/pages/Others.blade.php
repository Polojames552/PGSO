@extends('layouts.app', ['activePage' => 'Others', 'titlePage' => __('Others')])
  ...
  <div class="container-fluid">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple" class="TableData">
                                    ...
                                    <tbody>
                                    @foreach($data_other as $data_other) 
                                        <tr>
                                  <td>{{$data_other->id}}</td>
                                  <td>{{$data_other->other_name}}</td>
                                  <td>{{$data_other->number}}</td>
                                        <td>
	...
	<div id="addEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			...
			<form action="add_other" method="post" enctype="multipart/form-data">
                      {{ csrf_field() }}
					<div class="modal-header">						
						<h4 class="modal-title">Add Other Data</h4>
			...
			<div class="modal-body">					
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            <label>Other</label>
                            <input name="other_name" type="text" class="form-control" required>
                        </div>	
                    </div>		
                    <div class="form-group">
                        <div class="col-12">
	...
	<div id="editEmployeeModal" class="modal fade">
		<div class="modal-dialog">
            ...
            <form action="editother" method="post" enctype="multipart/form-data" id="editForm">
                      {{ csrf_field() }}
					<div class="modal-header">						
						<h4 class="modal-title">Edit Other Data</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					</div>
          <div class="modal-body">
                    <div class="form-group">
                        <div class="col-12">
                            <label>Other</label>
                            <input id="EditOther" name="EditOther" type="text" class="form-control" required>
                        </div>	
                    </div>		
                    <div class="form-group">
                        <div class="col-12">
              ...
              $(document).ready(function(){
                  ...
                  $('.TableData').on('click', '#deletebtn', function(){
                    ...
                    //   $('#youth_name').val(data[1]);
                      $('#delete_modal_Form').attr('action', 'other-delete/'+data[0]);
                  ...
                  $('.TableData').on('click', '#editbtn', function(){
                    $tr = $(this).closest('tr');
                      ...
                      $('#EditOther').val(data[1]);
                      $('#EditNumber').val(data[2]);
                      $('#editForm').attr('action', 'editother/'+data[0]);
