@extends('layouts.app', ['activePage' => 'GPSS', 'titlePage' => __('GPSS')])
  ...
  <div class="container-fluid">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple" class="TableData">
                                    ...
                                    <tbody>
                                    @foreach($data_gpss as $data_gpss) 
                                        <tr>
										    <td>{{$data_gpss->id}}</td>
											<td>{{$data_gpss->Gpss}}</td>
											<td>{{$data_gpss->number}}</td>
                                        <td>
		...
		<div class="modal-dialog">
			...
			<div class="modal-body">					
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            <label>GPSS</label>
                            <input name="Gpss" type="text" class="form-control" required>
                        </div>	
                    </div>		
                    <div class="form-group">
                        <div class="col-12">
	...
	<div id="editEmployeeModal" class="modal fade">
		<div class="modal-dialog">
            ...
            <form action="editgpss" method="post" enctype="multipart/form-data" id="editForm">
                      {{ csrf_field() }}
					<div class="modal-header">						
          ...
          <div class="modal-body">
                    <div class="form-group">
                        <div class="col-12">
                            <label>GPSS</label>
                            <input id="EditGpss" name="EditGpss" type="text" class="form-control" required>
                        </div>	
                    </div>		
                    <div class="form-group">
                        <div class="col-12">
              ...
              $(document).ready(function(){
                  ...
                  $('.TableData').on('click', '#deletebtn', function(){
                    ...
                    //   $('#youth_name').val(data[1]);
                      $('#delete_modal_Form').attr('action', 'gpss-delete/'+data[0]);
                  ...
                  $('.TableData').on('click', '#editbtn', function(){
                    $tr = $(this).closest('tr');
                      ...
                      $('#editForm').attr('action', 'editgpss/'+data[0]);
