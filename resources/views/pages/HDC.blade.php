@extends('layouts.app', ['activePage' => 'HDC', 'titlePage' => __('HDC')])
  ...
  <div class="container-fluid">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple" class="TableData">
                                    ...
                                    <tbody>
                                    @foreach($data_hdc as $data_hdc) 
                                        <tr>
                                  <td>{{$data_hdc->id}}</td>
                                  <td>{{$data_hdc->hdc_name}}</td>
                                  <td>{{$data_hdc->number}}</td>
                                        <td>
	...
	<div id="addEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			...
			<form action="add_hdc" method="post" enctype="multipart/form-data">
                      {{ csrf_field() }}
					<div class="modal-header">						
						<h4 class="modal-title">Add HDC Data</h4>
			...
			<div class="modal-body">					
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            <label>HDC</label>
                            <input name="hdc_name" type="text" class="form-control" required>
                        </div>	
                    </div>		
                    <div class="form-group">
                        <div class="col-12">
	...
	<div id="editEmployeeModal" class="modal fade">
		<div class="modal-dialog">
            ...
            <form action="edithdc" method="post" enctype="multipart/form-data" id="editForm">
                      {{ csrf_field() }}
					<div class="modal-header">						
						<h4 class="modal-title">Edit HDC</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					</div>
          <div class="modal-body">
                    <div class="form-group">
                        <div class="col-12">
                            <label>GPSS</label>
                            <input id="EditGpss" name="EditHdc" type="text" class="form-control" required>
                        </div>	
                    </div>		
                    <div class="form-group">
                        <div class="col-12">
              ...
              $(document).ready(function(){
                  ...
                  $('.TableData').on('click', '#deletebtn', function(){
                    ...
                    //   $('#youth_name').val(data[1]);
                      $('#delete_modal_Form').attr('action', 'hdc-delete/'+data[0]);
                  ...
                  $('.TableData').on('click', '#editbtn', function(){
                    $tr = $(this).closest('tr');
                      ...
                      $('#editForm').attr('action', 'edithdc/'+data[0]);
