@extends('layouts.app', ['activePage' => 'SW', 'titlePage' => __('SW')])
  ...
  <div class="container-fluid">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple" class="TableData">
                                    ...
                                    <tbody>
                                    @foreach($data_sw as $data_sw) 
                                        <tr>
                                  <td>{{$data_sw->id}}</td>
                                  <td>{{$data_sw->sw_name}}</td>
                                  <td>{{$data_sw->number}}</td>
                                        <td>
	...
	<div id="addEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			...
			<form action="add_sw" method="post" enctype="multipart/form-data">
                      {{ csrf_field() }}
					<div class="modal-header">						
						<h4 class="modal-title">Add SW Data</h4>
			...
			<div class="modal-body">					
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            <label>SSS</label>
                            <input name="sw_name" type="text" class="form-control" required>
                        </div>	
                    </div>		
                    <div class="form-group">
                        <div class="col-12">
	...
	<div id="editEmployeeModal" class="modal fade">
		<div class="modal-dialog">
            ...
            <form action="editsw" method="post" enctype="multipart/form-data" id="editForm">
                      {{ csrf_field() }}
					<div class="modal-header">						
						<h4 class="modal-title">Edit SSS Data</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					</div>
          <div class="modal-body">
                    <div class="form-group">
                        <div class="col-12">
                            <label>SSS</label>
                            <input id="EditSw" name="EditSw" type="text" class="form-control" required>
                        </div>	
                    </div>		
                    <div class="form-group">
                        <div class="col-12">
              ...
              $(document).ready(function(){
                  ...
                  $('.TableData').on('click', '#deletebtn', function(){
                    ...
                    //   $('#youth_name').val(data[1]);
                      $('#delete_modal_Form').attr('action', 'sw-delete/'+data[0]);
                  ...
                  $('.TableData').on('click', '#editbtn', function(){
                    $tr = $(this).closest('tr');
                      ...
                      $('#editForm').attr('action', 'editsw/'+data[0]);
