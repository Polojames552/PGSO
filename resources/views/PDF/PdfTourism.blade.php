        ...
        <?php $page = 1 ?>
            ...
            @elseif($n == 40)
               ...
               <!-- <center><p class="sign">Page</p></center> -->
                ...
                <?php $page_Other_Machine_Eq = 0?>
            @else
                <?php $page_Aquisition_Cost = $tour->Aquisition_Cost + $page_Aquisition_Cost ?>
                <?php $total_Aquisition_Cost = $page_Aquisition_Cost + $total_Aquisition_Cost ?>
                
                <?php $page_Med_Dental = $tour->Med_dental_equipment + $page_Med_Dental ?>
                <?php $total_Med_Dental = $page_Med_Dental + $total_Med_Dental ?>

                <?php $page_Office_Eq = $tour->Office_Eq + $page_Office_Eq ?>
                <?php $total_Office_Eq = $page_Office_Eq + $total_Office_Eq ?>

                <?php $page_Hospital_Eq = $tour->Hospital_Eq + $page_Hospital_Eq ?>
                <?php $total_Hospital_Eq = $page_Hospital_Eq + $total_Hospital_Eq ?>

                <?php $page_FnF = $tour->FurnitureNFixtures + $page_FnF ?>
                <?php $total_FnF = $page_FnF + $total_FnF ?>
                
                <?php $page_Motor_V = $tour->Motor_Vehicles + $page_Motor_V ?>
                <?php $total_Motor_V = $page_Motor_V + $total_Motor_V ?>

                <?php $page_Information_Tech = $tour->Info_Tech + $page_Information_Tech ?>
                <?php $total_Information_Tech = $page_Information_Tech + $total_Information_Tech ?>

                <?php $page_Other_Machine_Eq = $tour->Other_Machine_Eq + $page_Other_Machine_Eq ?>
