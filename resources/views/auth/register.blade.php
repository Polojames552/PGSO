    ...
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      ...
      {{csrf_field()}}
        ...
        <div class="card card-login card-hidden mb-3" >
          ...
          <div class="alert alert-danger" id="error" style="display: none;"></div>
            ...
            <div class="bmd-form-group{{ $errors->has('phone') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                ...
                <input type="text" name="phone" id="phone" class="form-control" placeholder="{{ __('+639.........') }}" value="{{ old('phone') }}" required>
              </div>
              @if ($errors->has('phone'))
          ...
          <center>
            <a href="{{ route('welcome') }}" class="text" id="createacc">
                <strong>{{ __('I already have an account!') }}</strong>
            </a>
            </center><br>
        </div>
              ...
              $.ajax({
                ...
                success:function(result){
                  if(result == 'unique'){
                    ...
                    $('#error').addClass('has-error');
                   $('#error_email').html('<label class="text-danger">This Email is already in use.</label>');
                   $('#OTPbtn').attr('disabled', 'disabled');
                  }
                }
              })
