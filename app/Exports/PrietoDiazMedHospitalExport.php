...
class PrietoDiazMedHospitalExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    ...
    {
        return PrietoDiazMedHospital::select(
        'Property_No',
        'Description',
        'Date_Aquired',
        'Aquisition_Cost',
    ...
    public function registerEvents(): array
    {
        return [
            ...
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $num1 = PrietoDiazMedHospital::query()->count()+1;
