...
use App\Exports\PrietoDiazMedHospitalExport;
use Maatwebsite\Excel\Facades\Excel;
class PrietoDiazMedHospitalController extends Controller
{
    function Health_show(){
        $health = DB::table('prieto_diaz_med_hospitals')->get();
        return view('pages.PrietoDiazMedHospital',['health'=>$health]);
    }
    public function store(Request $request)
    {
       
        $data = new PrietoDiazMedHospital();
        ...
        $data->save();
        return redirect('PrietoDiazMedHospital')->with('message','Data Added Successfully!');;
    }
    public function destroy($id)
    {
        $item = DB::table('prieto_diaz_med_hospitals')->where('Property_No', $id);
        $item->delete();
        return redirect('PrietoDiazMedHospital')->with('message', 'The data is successfully deleted!');
    }
    public function update_health(Request $request, $id)
    {
        ...
        DB::table('prieto_diaz_med_hospitals')
        ...
        return redirect('PrietoDiazMedHospital')->with('message','Data updated successfully!');;
    }
