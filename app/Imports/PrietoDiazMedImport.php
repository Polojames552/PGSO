...
class PrietoDiazMedImport implements ToModel , WithStartRow
// class PrietoDiazMedImport implements ToModel, WithHeadingRow , WithValidation
{
    /**
    * @param array $row
    *
